...
uiDesignTools.gradients.templates.linearGradientMaker.linearGradientMakerControlsTemplate = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div id="linearGradientMakerControls" class="linearGradient-controls"><div id="linearGradientOptions" class="linearGradient-options"><label for="linearGradientSideOrCorner">gradient direction</label><select id="linearGradientSideOrCorner"><option value="top">top</option><option value="top left">top left</option><option value="top right">top right</option><option value="bottom">bottom</option><option value="bottom left">bottom left</option><option value="bottom right">bottom right</option><option value="right">right</option><option value="left">left</option></select></div><!-- all controls related to color stops --><div id="colorStopsComponent" class="linearGradient-colorStopsComponent"><h4>Color Stops</h4><!-- write out colorStops button panel (add colorStop)--><div id="colorStopsButtonPanel" class="linearGradient-colorStopsButtonPanel"><div id="addColorStopButtonContainer" class="linearGradient-colorStopButtonContainer"><input id="addColorStopButton" type="button" value="Add Color Stop"></div></div>');
