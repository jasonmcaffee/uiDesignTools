...
uiDesignTools.gradients.templates.linearGradientMaker.linearGradientMakerControlsTemplate = function(opt_data, opt_sb) {
  ...
  output.append('</div><div id="linearGradientDirectionScreen" class="lg-gradient-direction-screen"><div id="linearGradientOptions" class="linearGradient-options"><label for="linearGradientSideOrCorner">gradient direction</label><select id="linearGradientSideOrCorner"><option value="top">top</option><option value="top left">top left</option><option value="top right">top right</option><option value="bottom">bottom</option><option value="bottom left">bottom left</option><option value="bottom right">bottom right</option><option value="right">right</option><option value="left">left</option></select></div></div><div id="linearGradientGradientTypeScreen" class="lg-gradient-type-screen"><div id="gradientTypeSelectionContainer"><div id="linearGradientSelection" class="lg-gradient-type-selection"><img src="img/plusButton.png" alt="Linear Gradient" /><label>Linear Gradient</label></div><div id="circularGradientSelection" class="lg-gradient-type-selection"><img src="img/plusButton.png" alt="Circular Gradient" /><label>Circular Gradient</label></div><div id="elipticalGradientSelection" class="lg-gradient-type-selection"><img src="img/plusButton.png" alt="Eliptical Gradient" /><label>Eliptical Gradient</label></div><div id="repeatingGradientSelection" class="lg-gradient-type-selection"><img src="img/plusButton.png" alt="Repeating Gradient" /><label>Repeating Gradient</label></div></div></div></div>');
  return opt_sb ? '' : output.toString();
};
