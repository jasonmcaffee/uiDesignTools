 ...
 * Contains: inputtypes | iepp | cssclasses | load
 */
;
window.Modernizr = function(a, b, c) {
    function z() {
        e.inputtypes = function(a) {
            for (var d = 0, e, f, h, i = a.length; d < i; d++)
                l.setAttribute("type", f = a[d]), e = l.type !== "text", e && (l.value = m, l.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(f) && l.style.WebkitAppearance !== c ? (g.appendChild(l), h = b.defaultView, e = h.getComputedStyle && h.getComputedStyle(l, null).WebkitAppearance !== "textfield" && l.offsetHeight !== 0, g.removeChild(l)) : /^(search|tel)$/.test(f) || (/^(url|email)$/.test(f) ? e = l.checkValidity && l.checkValidity() === !1 : /^color$/.test(f) ? (g.appendChild(l), g.offsetWidth, e = l.value != m, g.removeChild(l)) : e = l.value != m)), p[a[d]] = !!e;
            return p
    ...
    var d = "2.0.6", e = {}, f = !0, g = b.documentElement, h = b.head || b.getElementsByTagName("head")[0], i = "modernizr", j = b.createElement(i), k = j.style, l = b.createElement("input"), m = ":)", n = Object.prototype.toString, o = {}, p = {}, q = {}, r = [], s, t = {}.hasOwnProperty, u;
    ...
    for (var A in o)
        u(o, A) && (s = A.toLowerCase(), e[s] = o[A](), r.push((e[s] ? "" : "no-") + s));
    e.input || z(), v(""), j = l = null, a.attachEvent && function() {
    ...
    }(a, b), e._version = d, g.className = g.className.replace(/\bno-js\b/, "") + (f ? " js " + r.join(" ") : "");
    return e
